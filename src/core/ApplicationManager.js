...
class ApplicationManager {
    constructor() {
        ...
        /**
         * 设置 landing page 的布局
         * @param {Integer} titlebar 最顶上的标题行的高度
         * @param {String} containerId 整个应用的 div id
         * @param {String} sideId 左侧导航 div id
         * @param {String} contentId 中间主内容区 div id
         */
     ...
     * 设置项目 Note 页面的布局
     * @param {Integer} titlebar  最顶上的标题行的高度
     * @param {*} categoryContainerId 中间主区域 div id
     * @param {*} containerId 整个应用的 div id
     * @param {*} categories  没有折叠的分类
     * @param {*} foldedCategories 折叠的分类
     * @param {*} foldDrawer 
     */
